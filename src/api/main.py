"""Patch Management Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Patch management agent that identifies missing patches, prioritizes by risk and exploitability, schedules deployment windows, manages rollback procedures, and tracks patch compliance across the enterprise.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
